...
System.register("compiler/kind/DefnKind", [], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("DefnKind", DefnKind);
        }
    }
});
System.register("compiler/define/Defn", [], function(exports_2, context_2) {
    "use strict";
...
System.register("compiler/kind/PrimKind", [], function(exports_3, context_3) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_3("PrimKind", PrimKind);
        }
    }
});
System.register("compiler/define/PrimitiveDefn", ["compiler/kind/PrimKind", "compiler/define/Defn", "compiler/kind/DefnKind"], function(exports_4, context_4) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_4("PrimitiveDefn", PrimitiveDefn);
        }
    }
});
System.register("compiler/errors/CapturedError", [], function(exports_5, context_5) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_5("CapturedError", CapturedError);
        }
    }
});
System.register("compiler/errors/InternalError", ["compiler/errors/CapturedError"], function(exports_6, context_6) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_6("InternalError", InternalError);
        }
    }
});
System.register("compiler/utils/index", ["compiler/kind/DefnKind", "compiler/errors/InternalError"], function(exports_7, context_7) {
    "use strict";
...
System.register("compiler/kind/MethodKind", [], function(exports_8, context_8) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_8("MethodKind", MethodKind);
        }
    }
});
System.register("compiler/entities/Method", [], function(exports_9, context_9) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_9("Method", Method);
        }
    }
});
System.register("compiler/entities/PropQual", [], function(exports_10, context_10) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_10("PropQual", PropQual);
        }
    }
});
System.register("compiler/entities/Prop", [], function(exports_11, context_11) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_11("Prop", Prop);
        }
    }
});
System.register("compiler/define/StructDefn", ["compiler/define/UserDefn", "compiler/kind/DefnKind", "compiler/kind/MethodKind"], function(exports_12, context_12) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_12("StructDefn", StructDefn);
        }
    }
});
System.register("compiler/define/UserDefn", ["compiler/kind/DefnKind", "compiler/define/Defn", "compiler/kind/PrimKind"], function(exports_13, context_13) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_13("UserDefn", UserDefn);
        }
    }
});
System.register("compiler/entities/Virtual", [], function(exports_14, context_14) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_14("Virtual", Virtual);
        }
    }
});
System.register("compiler/define/ClassDefn", ["compiler/define/UserDefn", "compiler/define/Defn", "compiler/kind/DefnKind"], function(exports_15, context_15) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_15("ClassDefn", ClassDefn);
        }
    }
});
System.register("compiler/CONST", [], function(exports_16, context_16) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_16("Ws", Ws = "\\s+");
            exports_16("Os", Os = "\\s*");
            exports_16("Id", Id = "[A-Za-z][A-Za-z0-9]*"); // Note, no underscores are allowed yet
            exports_16("Lbrace", Lbrace = Os + "\\{");
            exports_16("Rbrace", Rbrace = Os + "\\}");
            exports_16("LParen", LParen = Os + "\\(");
            exports_16("CommentOpt", CommentOpt = Os + "(?:\\/\\/.*)?");
            exports_16("QualifierOpt", QualifierOpt = "(?:\\.(atomic|synchronic))?");
            exports_16("OpNames", OpNames = "at|get|setAt|set|ref|add|sub|and|or|xor|compareExchange|loadWhenEqual|loadWhenNotEqual|expectUpdate|notify");
            exports_16("Operation", Operation = "(?:\\.(" + OpNames + "))");
            exports_16("OperationOpt", OperationOpt = Operation + "?");
            exports_16("OperationLParen", OperationLParen = "(?:\\.(" + OpNames + ")" + LParen + ")");
            exports_16("NullaryOperation", NullaryOperation = "(?:\\.(ref|notify))");
            exports_16("Path", Path = "((?:\\." + Id + ")+)");
            exports_16("PathLazy", PathLazy = "((?:\\." + Id + ")+?)");
            exports_16("PathOpt", PathOpt = "((?:\\." + Id + ")*)");
            exports_16("PathOptLazy", PathOptLazy = "((?:\\." + Id + ")*?)");
            exports_16("AssignOp", AssignOp = "(=|\\+=|-=|&=|\\|=|\\^=)(?!=)");
            exports_16("start_re", start_re = new RegExp("^" + Os + "@turbo::" + Ws + "(?:struct|class)" + Ws + "(?:" + Id + ")"));
            exports_16("end_re", end_re = new RegExp("^" + Rbrace + Os + "@end" + CommentOpt + "$"));
            exports_16("struct_re", struct_re = new RegExp("^" + Os + "@turbo::" + Ws + "struct" + Ws + "(" + Id + ")" + Lbrace + CommentOpt + "$"));
            exports_16("class_re", class_re = new RegExp("^" + Os + "@turbo::" + Ws + "class" + Ws + "(" + Id + ")" + Os + "(?:extends" + Ws + "(" + Id + "))?" + Lbrace + CommentOpt + "$"));
            exports_16("special_re", special_re = new RegExp("^" + Os + "@(get|set)" + "(" + LParen + Os + "SELF.*)$"));
            exports_16("method_re", method_re = new RegExp("^" + Os + "@(method|virtual)" + Ws + "(" + Id + ")" + "(" + LParen + Os + "SELF.*)$"));
            exports_16("blank_re", blank_re = new RegExp("^" + Os + CommentOpt + "$"));
            exports_16("space_re", space_re = new RegExp("^" + Os + "$"));
            exports_16("prop_re", prop_re = new RegExp("^" + Os + "(" + Id + ")" + Os + ":" + Os + "(" + Id + ")" + QualifierOpt + "(?:\.(Array))?" + Os + ";?" + CommentOpt + "$"));
            exports_16("new_re", new_re = new RegExp("@new\\s+(" + Id + ")" + QualifierOpt + "(?:\\.(Array)" + LParen + ")?", "g"));
            exports_16("acc_re", acc_re = new RegExp("(" + Id + ")" + PathOptLazy + "(?:" + Operation + "|)" + LParen, "g"));
            // It would sure be nice to avoid the explicit ".Array" here, but I don't yet know how.
            exports_16("arr_re", arr_re = new RegExp("(" + Id + ")" + QualifierOpt + "\\.Array" + PathOpt + Operation + LParen, "g"));
            // Macro expansion and pasteup
            exports_16("self_getter1_re", self_getter1_re = new RegExp("SELF" + Path + NullaryOperation, "g"));
            exports_16("self_getter2_re", self_getter2_re = new RegExp("SELF" + Path, "g"));
            exports_16("self_accessor_re", self_accessor_re = new RegExp("SELF" + Path + OperationLParen, "g"));
            exports_16("self_setter_re", self_setter_re = new RegExp("SELF" + Path + Os + AssignOp + Os, "g"));
            exports_16("self_invoke_re", self_invoke_re = new RegExp("SELF\\.(" + Id + ")" + LParen, "g"));
            ...
            exports_16("AssignmentOps", AssignmentOps = {
                "=": "set",
                "+=": "add",
                "-=": "sub",
                "&=": "and",
...
System.register("compiler/errors/UsageError", ["compiler/errors/CapturedError"], function(exports_17, context_17) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_17("UsageError", UsageError);
        }
    }
});
System.register("compiler/source/SourceLine", [], function(exports_18, context_18) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_18("SourceLine", SourceLine);
        }
    }
});
System.register("compiler/source/Source", [], function(exports_19, context_19) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_19("Source", Source);
        }
    }
});
System.register("compiler/errors/ProgramError", ["compiler/errors/CapturedError"], function(exports_20, context_20) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            exports_20("ProgramError", ProgramError);
        }
    }
});
System.register("compiler/parser/ParamParser", ["compiler/errors/ProgramError"], function(exports_21, context_21) {
    "use strict";
...
System.register("compiler/services/DefinitionService", ["compiler/source/SourceLine", "compiler/entities/Prop", "compiler/entities/Method", "compiler/kind/MethodKind", "compiler/errors/ProgramError", "compiler/define/ClassDefn", "compiler/define/StructDefn", "compiler/CONST", "compiler/entities/PropQual", "compiler/parser/ParamParser"], function(exports_22, context_22) {
    "use strict";
...
System.register("compiler/source/SourceProvider", ["compiler/errors/UsageError", "fs", "compiler/source/Source", "compiler/errors/CapturedError", "compiler/services/DefinitionService"], function(exports_23, context_23) {
    "use strict";
...
System.register("compiler/define/AtomicDefn", ["compiler/define/PrimitiveDefn", "compiler/kind/PrimKind"], function(exports_24, context_24) {
    "use strict";
...
System.register("compiler/define/SynchronicDefn", ["compiler/define/PrimitiveDefn", "compiler/kind/PrimKind"], function(exports_25, context_25) {
    "use strict";
...
System.register("compiler/define/SIMDDefn", ["compiler/define/PrimitiveDefn", "compiler/kind/PrimKind"], function(exports_26, context_26) {
    "use strict";
...
System.register("compiler/iterators/VirtualMethodIterator", ["compiler/utils/index", "compiler/kind/MethodKind"], function(exports_27, context_27) {
    "use strict";
...
System.register("compiler/iterators/InclusiveSubclassIterator", [], function(exports_28, context_28) {
    "use strict";
...
System.register("compiler/Compiler", ["compiler/source/SourceProvider", "compiler/define/PrimitiveDefn", "compiler/utils/index", "compiler/define/Defn", "compiler/define/AtomicDefn", "compiler/define/SynchronicDefn", "compiler/define/SIMDDefn", "compiler/errors/ProgramError", "compiler/kind/DefnKind", "compiler/entities/PropQual", "compiler/kind/MethodKind", "compiler/errors/InternalError", "compiler/entities/Virtual", "compiler/iterators/VirtualMethodIterator", "fs", "compiler/iterators/InclusiveSubclassIterator", "compiler/source/SourceLine", "compiler/CONST", "compiler/parser/ParamParser", "compiler/kind/PrimKind"], function(exports_29, context_29) {
    "use strict";
        ...
        execute: function() {
            ...
            Compiler = (function () {
                    ...
                    if (shift >= 0) {
                        ...
                        switch (operation) {
                            case "get":
                                ...
                                break;
                            case "notify":
                                expr = "ll.Runtime." + CONST_2.OpAttr[operation].synchronic + "(" + ref + ")";
                                break;
                            case "set":
                            case "add":
                            case "sub":
                            ...
                            case "loadWhenNotEqual":
                                if (atomic)
                                    expr = "Atomics." + CONST_2.OpAttr[operation].atomic + "(ll.Runtime." + mem + ", " + fieldIndex + ", " + rhs + ")";
                                else if (synchronic)
                                    expr = "ll.Runtime." + CONST_2.OpAttr[operation].synchronic + "(" + ref + ", ll.Runtime." + mem + ", " + fieldIndex + ", " + rhs + ")";
                                else if (simd)
                                    expr = "SIMD." + simdType + ".store(ll.Runtime." + mem + ", " + fieldIndex + ", " + rhs + ")";
                                else
                                    expr = "ll.Runtime." + mem + "[" + ref + " >> " + shift + "] " + CONST_2.OpAttr[operation].vanilla + " " + rhs;
                                break;
                            case "compareExchange":
                            case "expectUpdate":
                                if (atomic)
                                    expr = "Atomics." + CONST_2.OpAttr[operation].atomic + "(ll.Runtime." + mem + ", " + fieldIndex + ", " + rhs + ", " + rhs2 + ")";
                                else
                                    expr = "ll.Runtime." + CONST_2.OpAttr[operation].synchronic + "(" + ref + ", ll.Runtime." + mem + ", " + fieldIndex + ", " + rhs + ", " + rhs2 + ")";
                                break;
                            default:
                ...
                Compiler.prototype.newMacro = function (file, line, s, p, ms) {
                    ...
                    // NOTE, parens removed here
                    // Issue #16: Watch it: Parens interact with semicolon insertion.
                    var expr = "ll.Runtime.allocOrThrow(" + t.elementSize + " * " + this.expandMacrosIn(file, line, index_2.endstrip(as[0])) + ", " + t.elementAlign + ")";
